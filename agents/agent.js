...
class Agent {
  ...
  // platshållarinnehåll. Sätt ANTHROPIC_API_KEY i miljövariabler för
  // riktig textgenerering. Bildgenerering kräver en separat tjänst -
  ...
  async generateContent() {
    ...
    if (this.kind === "text") {
      ...
      return {
        ...
        preview:
          "(Demo-läge: sätt ANTHROPIC_API_KEY i miljövariablerna på Render " +
          "för att låta agenten skapa riktigt innehåll med Claude.)",
        createdAt: new Date().toISOString(),
      };
    }
